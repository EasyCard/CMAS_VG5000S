...
USHORT usGetTXTYPE_TRANSTYPE(USHORT inTxnType)
{
	...
	case TXTYPE_DEBUG:
        ...
        case TXTYPE_SETTLEMENT:   
                 TransType=TransType_SETTLEMENT;break;
	}
    return TransType;
}
/*
 ...
 void vGetTxTitleStr(BYTE TXTYPE,STR * Title)
 {
  ...
  switch(TXTYPE){
        ...
        case TXTYPE_SETVALUE:
			...
			break;
        case TXTYPE_SETTLEMENT :
                         sprintf(Title,"%s",Title_SETTLEMENT);break;
        case TXTYPE_AUTOLOADENABLE :
			break;
        case TXTYPE_REFUND :  
                     
                        sprintf(Title,"%s",Title_Refund);break;
        ...
        case TXTYPE_DEBUG:break;
         ...
         case TXTYPE_AUTOLOAD    :  
			...
			sprintf(Title,"%s",Title_AUTOLOAD);break;
			break;
         }            
 }
...
USHORT SaveBackupTxData(TRANS_DATA2 *TransData)
{
    ...
    BYTE ucBatchNo[8+1];USHORT  usBatchSN;
...
{
     STR filename[64];memset(filename,0x00,sizeof(filename));
